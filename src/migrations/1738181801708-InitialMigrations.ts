...
export class InitialMigrations1738181801708 implements MigrationInterface {
    name = 'InitialMigrations1738181801708'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "products" ("id" SERIAL NOT NULL, "productName" character varying(150) NOT NULL, "description" character varying(200) NOT NULL, "category" character varying array NOT NULL, "img" character varying NOT NULL, "link" character varying NOT NULL, "price" numeric(10,2) NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "deletedAt" date, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
